...
--
-- Host: 127.0.0.1    Database: ql_cap_nuoc
-- ------------------------------------------------------
...
CREATE TABLE `dm_chinhanh` (
  `ma_chi_nhanh` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `dm_codongho` (
  `ma_co_dong_ho` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `dm_loaidongho` (
  `ma_loai_dong_ho` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `dm_loaikhachhang` (
  `ma_loai_khach_hang` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `dm_phuongxa` (
  `ma_phuong_xa` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `dm_toquanly` (
  `ma_to_quan_ly` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `dm_tuyendoc` (
  `ma_tuyen` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ql_donghokhach` (
  `ma_dong_ho` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ql_hopdong` (
  `ma_hop_dong` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `ql_hopdong_ibfk_1` FOREIGN KEY (`ma_nhom_gia`) REFERENCES `ql_nhomgia` (`ma_nhom_gia`) ON UPDATE CASCADE,
  CONSTRAINT `ql_hopdong_ibfk_2` FOREIGN KEY (`ma_khach_hang`) REFERENCES `ql_khachhang` (`ma_khach_hang`) ON UPDATE CASCADE,
  CONSTRAINT `ql_hopdong_ibfk_3` FOREIGN KEY (`ma_tuyen`) REFERENCES `dm_tuyendoc` (`ma_tuyen`) ON UPDATE CASCADE
...
INSERT INTO `ql_khachhang` VALUES (1,'Phạm Thị Thu Hiền','031300005030','34/46 Lạch Tray','0834285958','ddmanh1420@gmail.com'),(2,'Nguyễn Văn A','000000000001','1 Lạch Tray','0000000001','NVA@qlcn.com'),(3,'Nguyễn Văn B','000000000002','2 Lạch Tray','0000000002','ddmanh1420@gmail.com'),(4,'Nguyễn Văn C','000000000003','3 Lạch Tray','0000000003','NVC@qlcn.com'),(5,'Nguyễn Văn D','000000000004','4 Lạch Tray','0000000004','NVD@qlcn.com'),(6,'Nguyễn Văn E','000000000005','5 Lạch Tray','0000000005','NVE@qlcn.com'),(7,'Nguyễn Văn F','000000000006','6 Lạch Tray','0000000006','NVF@qlcn.com'),(8,'Nguyễn Văn G','000000000007','7 Lạch Tray','0000000007','NVG@qlcn.com'),(9,'Nguyễn Văn H','000000000008','8 Lạch Tray','0000000008','NVH@qlcn.com'),(10,'Nguyễn Văn I','000000000009','9 Lạch Tray','0000000009','NVI@qlcn.com'),(11,'Nguyễn Văn J','000000000010','10 Lạch Tray','0000000010','NVJ@qlcn.com'),(12,'Nguyễn Văn K','000000000011','11 Lạch Tray','0000000011','NVK@qlcn.com'),(13,'Nguyễn Văn L','000000000012','12 Lạch Tray','0000000012','NVL@qlcn.com'),(14,'Nguyễn Văn M','000000000013','13 Lạch Tray','0000000013','NVM@qlcn.com'),(15,'Nguyễn Văn N','000000000014','14 Lạch Tray','0000000014','NVN@qlcn.com'),(16,'Nguyễn Văn O','000000000015','15 Lạch Tray','0000000015','NVO@qlcn.com'),(17,'Nguyễn Văn P','000000000016','16 Lạch Tray','0000000016','NVP@qlcn.com'),(18,'Nguyễn Văn Q','000000000017','17 Lạch Tray','0000000017','NVQ@qlcn.com'),(19,'Nguyễn Văn R','000000000019','19 Lạch Tray','0000000019','NVR@qlcn.com'),(20,'Nguyễn Văn S','000000000020','20 Lạch Tray','0000000020','NVS@qlcn.com'),(21,'Nguyễn Văn T','000000000021','21 Lạch Tray','0000000021','NVT@qlcn.com'),(22,'Nguyễn Văn U','000000000022','22 Lạch Tray','0000000022','NVU@qlcn.com'),(23,'Nguyễn Văn V','000000000023','23 Lạch Tray','0000000023','NVV@qlcn.com'),(24,'Nguyễn Văn W','000000000024','24 Lạch Tray','0000000024','NVW@qlcn.com'),(25,'Nguyễn Văn X','000000000025','25 Lạch Tray','0000000025','NVX@qlcn.com'),(26,'Nguyễn Văn Y','000000000026','26 Lạch Tray','0000000026','NVY@qlcn.com'),(27,'Nguyễn Văn Z','000000000027','27 Lạch Tray','0000000027','NVZ@qlcn.com');
...
CREATE TABLE `ql_lapdatdhkhach` (
  `ma_lap_dat` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ql_nhomgia` (
  `ma_nhom_gia` int(11) NOT NULL AUTO_INCREMENT,
  ...
  UNIQUE KEY `ten_nhom_gia` (`ten_nhom_gia`) USING HASH,
  KEY `ma_loai_khach_hang` (`ma_loai_khach_hang`),
...
CREATE TABLE `ql_phanquyen` (
  `ma_phan_quyen` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ql_taikhoan` (
  `ma_nhan_vien` int(6) NOT NULL AUTO_INCREMENT,
...
-- Dump completed on 2024-06-04  0:11:44

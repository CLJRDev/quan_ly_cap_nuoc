...
) ENGINE=InnoDB AUTO_INCREMENT=100048 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ql_taikhoansocial` (
  ...
  KEY `ql_taikhoansocial_ibfk_1` (`ma_nhan_vien`),
  CONSTRAINT `ql_taikhoansocial_ibfk_1` FOREIGN KEY (`ma_nhan_vien`) REFERENCES `ql_taikhoan` (`ma_nhan_vien`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ql_taikhoansocial` VALUES (11,100034,'101374469411897176353','Mark Do','google'),(14,100000,'113320842243234835948','Mạnh Đỗ','google'),(15,100047,'106013666646116865227','Mạnh Đỗ Đức','google');
...
-- Dump completed on 2024-06-05 17:10:13
